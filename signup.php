    			...
    			<div class="us-details col-md-6">
    				...
    				<div class="col-md-6">
    					<div class="sign-details">
    						<form class="signup_action.php" method="POST" class="ui-form">
                            ...
                            <div class="form-group">
                                <label><?=$L["Confirm_Password"]?></label>
                                <input type="text" name="Confirm_Password" class="form-control" placeholder="Confirm Password">
                            </div>
                            <button class="ui-btn is-secondary has-busy is-auto is-island gtm-sign-up"><span class="label">Sign up</span><span class="spin"></span></button>
                           ...
                           <!--  <input type="Submit" name="Submit" value="signup"> -->
    						...
    						<div class="login-details">
    							<h2 class="t-center">Already have an account?</h2>
    							<div class="t-center">
